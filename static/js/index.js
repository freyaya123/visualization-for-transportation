...
$(function () {
    ...
    $('#createStatsMap2').click(function() {
        ...
        var chart2 = document.getElementById("statsChart2");
        var statsChart2 = echarts.init(chart2);
        if (statsChart2Option && typeof statsChart2Option === "object") {
            statsChart2.setOption(option, true);
        }
        */
        getLineBar();
