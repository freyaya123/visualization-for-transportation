...
def predict_duration(yy, mm, dd, hh, pick, drop):
    '''
    predict the duration, and give the possible routes
    :param yy:
    :param mm: 1-6
    :param dd:
    :param hh:
...
if __name__ == '__main__':
    ...
    print(predict_duration(2016, 3, 2, 3, pick, drop))
